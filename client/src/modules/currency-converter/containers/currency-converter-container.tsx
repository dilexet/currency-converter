...
import {
  ...
  getCurrencies,
} from '../store/action-creator/currency-conversation-actions'
...
const CurrencyConverterContainer: React.FC = () => {
  ...
  const changeAndSaveBaseCurrency = (newBaseCurrency: ICurrencySelect): void => {
