...
export interface ICurrencyListTableBodyComponentProps {
    ...
    handleRemoveFromFavorite: (e: React.MouseEvent<SVGSVGElement, MouseEvent>, favoriteCurrencyCode: string) => Promise<void>
    handleAddToFavorite: (e: React.MouseEvent<SVGSVGElement, MouseEvent>, favoriteCurrencyCode: string) => Promise<void>
}
